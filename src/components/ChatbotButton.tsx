...
const ChatBotButton: React.FC = () => {
  ...
  return (
    <>
      <button
        onClick={toggleChat}
        className={`fixed bottom-4 right-6 flex items-center justify-center p-4 text-white rounded-full shadow-2xl transform transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 z-10 group ${
          isDarkMode
